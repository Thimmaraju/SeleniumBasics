...
public class UntitledTestCase {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Log Out'])[2]/following::a[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Maddie’s Pet Forum'])[4]/following::span[3]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Add Title of Discussion'])[1]/following::text[1]")).click();
